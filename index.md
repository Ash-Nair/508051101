...
You can use the [editor on GitHub](https://github.com/Ash-Nair/508051101/edit/master/index.md) to maintain and preview the content for your website in Markdown files.
...
Your Pages site will use the layout and styles from the Jekyll theme you have selected in your [repository settings](https://github.com/Ash-Nair/508051101/settings). The name of this theme is saved in the Jekyll `_config.yml` configuration file.
...
<script type="text/javascript">
          (function(){
            ...
            useriq.identify(user_id, {
              user_name: 'INSERT_ACCOUNT_ID_HERE',
              account_id: account_id,
              account_name: 'ashwin',
              user_email: 'ashwin.nair+nu2@useriq.com',
